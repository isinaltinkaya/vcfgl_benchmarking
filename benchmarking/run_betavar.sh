...
# for dp in 0.1 0.5 1 2 10 20;do
	# { time /maps/projects/lundbeck/scratch/pfs488/vcfgl/vcfgl_paper_analyses/benchmarking/vcfgl/vcfgl -i sim_vcfgl_2312-OutOfAfrica_3G09-chr22.vcf --error-qs 2 --beta-variance 1e-5 -s 1 -d ${dp} -e 0.002  -o outd${dp}_qs2_beta5 2> outd${dp}_qs2_beta5.log ; } 2> time_outd${dp}_qs2_beta5
# done
#
#
#
